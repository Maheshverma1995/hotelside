          ...
          <div className="row">
            <div className="col-md-3">
              <div className="text-center position-relative">
                ...
                <div className="arrow-icon position-absolute d-none d-lg-block top:50px; right:-25px">
            ...
            <div className="col-md-3">
              <div className="text-center position-relative">
                <div className="step-icon mx-auto bg-primary border rounded-circle d-flex align-items-center justify-content-center width: 120px;height: 120px;">
                  <svg className="bi bi-envelope-exclamation text-white" fill="currentColor" height="30" viewbox="0 0 16 16" width="30" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="col-md-3">
              <div className="text-center position-relative">
                <div className="step-icon mx-auto bg-primary border rounded-circle d-flex align-items-center justify-content-center width: 120px;height: 120px;">
                  <svg className="bi bi-truck text-white" fill="currentColor" height="40" viewbox="0 0 16 16" width="40" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="col-md-3">
              <div className="text-center position-relative">
                <div className="step-icon mx-auto bg-primary border rounded-circle d-flex align-items-center justify-content-center width: 120px;height: 120px;">
                  <svg className="bi bi-qr-code text-white" fill="currentColor" height="40" viewbox="0 0 16 16" width="40" xmlns="http://www.w3.org/2000/svg">
